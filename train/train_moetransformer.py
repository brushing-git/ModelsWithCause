...
FN = 'moe_markov_chain-dice-100-normal-training.txt'
DATA_NAME = 'ME-Normal'
TEXTLENGTH = 100
...
def main():
    ...
    print("initializing and training switch transformer")
    ...
    for i, seed in enumerate(SEEDS):
        ...
        model_save_path = os.path.join(new_path, f'MoEDecoderTransformer_{N_HEADS}-{DECODER_LYRS}-{N_EXPERTS}-{FFN}_SEED_{seed}.pt')
