...
def main():
    ...
    print("initializing and training transformer")
    ...
    for i, seed in enumerate(SEEDS):
        ...
        model_save_path = os.path.join(new_path, f'Transformer_{N_HEADS}-{ENCODER_LYRS}-{DECODER_LYRS}-{FFN}_SEED_{seed}.pt')
