...
class MoEDecoderLayer(nn.Module):
    def __init__(self, dim_model: int, 
        ...
        self.sa = nn.MultiheadAttention(dim_model, n_heads, dropout=dropout, batch_first=False)
        self.ma = nn.MultiheadAttention(dim_model, n_heads, dropout=dropout, batch_first=False)
